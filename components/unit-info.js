...
const UnitInfo = ({
  ...
  return (
    <div
      className={`mq700:px-4 flex flex-col items-center justify-center h-full px-[0px] box-border min-w-[370px] max-w-full text-left text-[14px] text-[#494949] font-[Poppins] mq450:min-w-full grow w-full  ${className} py-3`}
    >
