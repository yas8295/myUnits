...
const Footer = () => {
  return (
    <footer
      className={`self-stretch bg-[#0512f5] shrink-0 flex items-center justify-center py-[29px] px-[60px] box-border gap-[70px] mq925:gap-[30px] text-left text-[14px] text-[#f2db00] font-[Poppins] flex-wrap mq925:flex-col max-w-screen`}
    >
      <Image
