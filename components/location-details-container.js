...
const LocationDetailsContainer = ({ className = "" }) => {
  return (
    <div
      className={`w-[305px] flex flex-col items-start justify-start pt-[0px] px-[0px] pb-[10px] box-border gap-[15px] text-left text-[14px] text-[#494949] font-[Poppins] ${className}`}
    >
