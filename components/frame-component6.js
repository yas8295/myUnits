...
const FrameComponent6 = ({ className = "",unit,units,setUnits }) => {
  return (
    <motion.div
    ...
    transition={{type:"spring",stiffness:60}}
      className={`self-stretch flex flex-col items-center justify-start gap-[10px] max-w-full text-left text-[14px] text-[#494949] font-[Poppins] ${className}`}
    >
